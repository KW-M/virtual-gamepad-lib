...
window.addEventListener("DOMContentLoaded", () => {
    ...
    window.onkeydown = (e) => {
        ...
        // all other gamepad buttons are mapped to the number keys or keycodes for high button numbers
            ...
            gpadEmulator.PressButton(EMULATED_GPAD_INDEX, e.keyCode - 65 + 10, touchNotPress ? 0 : 1, true); // 65 is the keycode for "a", 10 is the count of number keys on the keyboard (0-9), so "a" is button #10, "b" is button #11, etc.
    };
    window.onkeyup = (e) => {
        const numberKey = parseInt(e.key);
        // []+- to move the left joystick
        ...
        // all other gamepad buttons are mapped to the number keys or keycodes for high button numbers
            ...
            gpadEmulator.PressButton(EMULATED_GPAD_INDEX, e.keyCode - 65 + 10, 0, false); // 65 is the keycode for "a", 10 is the count of number keys on the keyboard (0-9), so "a" is button #10, "b" is button #11, etc.
    };
});
