// @ts-check
import spacePngPath from './space.png?url';
import spaceJsonPath from './space.json?url';
import explosionJsonPath from './explosion.json?url';
import explosionPngPath from './explosion.png?url';
import nebulaJpgPath from './nebula.jpg?url';

import("./phaser.js").then(() => {
    ...
    function preload() {
        this.load.image('background', nebulaJpgPath);
        this.load.atlas('space', spacePngPath, spaceJsonPath);
        this.load.atlas('explosion', explosionPngPath, explosionJsonPath);
    }
    ...
    function create() {
        ...
        this.add.image(0, 0, 'space', 'purple-planet').setOrigin(0);
